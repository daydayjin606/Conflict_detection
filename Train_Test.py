#!/usr/env python
# -*- coding:utf-8 -*-
# author:qianqian time:6/25/2024
...
def main():
    ...
    folder0_path = [r"D:\Video_frame\video_frames_a\0\3fps", r"D:\Video_frame\video_frames_b\0\3fps", r"D:\Video_frame\video_frames_c\0\3fps", r"D:\Video_frame\video_frames_d\0\3fps"]
    folder1_path = [r"D:\Video_frame\video_frames_a\1\3fps", r"D:\Video_frame\video_frames_b\1\3fps", r"D:\Video_frame\video_frames_c\1\3fps", r"D:\Video_frame\video_frames_d\1\3fps"]
    ...
    with open('training_ratio3_1fps_abc.txt', 'w') as f:
        for epoch in range(num_epochs):
            ...
            # val_metrics = calculate_classification_metrics(val_labels, val_predictions)
            # f.write(f"{json.dumps(val_metrics)}\n")
            # f.write(f'\nCurrent Validation loss: {val_running_loss}\n\n')
            # print('\n')
            #
    ...
    torch.save(model.state_dict(), 'Pretrain_model_ratio3_1fps_abc.pth')
    print('Model saved!')
